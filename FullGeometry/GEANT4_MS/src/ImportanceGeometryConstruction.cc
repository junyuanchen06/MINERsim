...
G4VIStore* ImportanceGeometryConstruction::CreateImportanceStore()
{
  ...
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(20).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(21).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(22).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(23).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(24).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(25).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(26).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(27).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(28).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(29).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(30).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(31).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(32).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(33).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,9), GetGeometryCell(34).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,10), GetGeometryCell(35).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,10), GetGeometryCell(36).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,10), GetGeometryCell(37).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,10), GetGeometryCell(38).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,10), GetGeometryCell(39).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,10), GetGeometryCell(40).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,10), GetGeometryCell(41).GetPhysicalVolume());
  ...
  istore->AddImportanceGeometryCell(std::pow(2,5), GetGeometryCell(61).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,5), GetGeometryCell(62).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,6), GetGeometryCell(63).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,6), GetGeometryCell(64).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,6), GetGeometryCell(65).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(66).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(67).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(68).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(69).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(70).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(71).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(72).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(73).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,7), GetGeometryCell(74).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(75).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(76).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(77).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(78).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(79).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(80).GetPhysicalVolume());
  istore->AddImportanceGeometryCell(std::pow(2,8), GetGeometryCell(81).GetPhysicalVolume());
