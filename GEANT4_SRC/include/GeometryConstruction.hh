...
class GeometryConstruction : public G4VUserDetectorConstruction
{
  ...
  private:
    ...
    G4LogicalVolume* fLogicGraphite;
    G4LogicalVolume* fLogicLead;
    G4LogicalVolume* fLogicPoly;
    G4LogicalVolume* fLogicConcrete;
    G4LogicalVolume* fLogicVac1;
    G4LogicalVolume* fLogicVac2;
    G4LogicalVolume* fLogicDet;

    G4LogicalVolume* fLogicLeadHouse;
    G4LogicalVolume* fLogicScintBox;
    G4LogicalVolume* fLogicLeadBox;
    G4LogicalVolume* fLogicPolyBox;
